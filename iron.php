<?php
    ...
    $miConsulta = $miPDO->prepare('SELECT * FROM albums where id_artist=4');
    $miConsulta->execute();
...
<body>
    ...
    <img src="images/pink.png" alt="pink.png"/></a>
    <br><br><br>
    ...
    <!--<div class="container">
        <div class="row">
          <div class="col-4">
            <img src="<?=$valor['portada']; ?>" width="400" height="400" alt="metallica.jpg"/>
          </div>
          <div class="col-4">
